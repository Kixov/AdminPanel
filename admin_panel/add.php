            ...
            <div class="panel">
                ...
                <div class="add">
                    ...
                    <form action="add_process.php" method="post">
                        <div>
                            <label for="txt_matricule">Matricule:</label><br>
                            <input type="text" name="txt_matricule">
                        </div>
                        <div>
                            <label for="txt_nom">Nom:</label><br>
                            <input type="text" name="txt_nom">
                        </div>
                        <div>
                            <label for="txt_prenom">Prenom:</label><br>
                            <input type="text" name="txt_prenom">
                        </div>
                        <div>
                            <label for="txt_imc">IMC:</label><br>
                            <input type="text" name="txt_imc">
                        </div>
                        <div>
